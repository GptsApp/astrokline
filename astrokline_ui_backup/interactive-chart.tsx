            ...
            {tier === 'GUEST' ? (
              <div className="relative mt-4">
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm">
                  ...
                  <p className="text-sm text-white/80 font-bold mb-3">Unlock Past Analysis</p>
                  <button onClick={() => onActionGate?.('past_validation', 'LITE')} className="bg-[#D4AF37] hover:bg-[#FCDD73] text-black font-bold text-xs px-6 py-2 transition-all">
                    Sign in to Reveal
                  </button>
                </div>
