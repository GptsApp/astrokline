...
Welcome to AstroKline, the **NextJS Boilerplate** designed to help you build AI SaaS startups quickly and efficiently. At AstroKline, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using AstroKline:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use AstroKline, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access AstroKline, such as device type, operating system, and browser type.
...
**Copyright Owner**: [astrokline-7hs.pages.dev](https://astrokline-7hs.pages.dev)
**Email**: [support@astrokline-7hs.pages.dev](mailto:support@astrokline-7hs.pages.dev)

By using AstroKline, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
