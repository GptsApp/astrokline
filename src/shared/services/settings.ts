...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: '7fcf090b47fd9cbb0a4334b32b23468f',
      tip: 'Used to build the default R2 endpoint when Endpoint is left empty',
      group: 'r2',
      tab: 'storage',
    },
    {
    ...
    },
    {
      ...
      type: 'url',
      placeholder: '',
      tip: 'Optional. Leave empty to serve uploaded files through this app',
      group: 'r2',
      tab: 'storage',
    },
    {
