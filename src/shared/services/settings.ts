...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: 'Infini',
      description:
        'custom your <a href="https://infini.money" class="text-primary" target="_blank">Infini</a> crypto payment settings',
      tab: 'payment',
    },
    {
    ...
    {
      name: 'sendflare',
      title: t('groups.sendflare'),
      description:
        'custom your <a href="https://sendflare.com" class="text-primary" target="_blank">Sendflare</a> settings',
      tab: 'email',
    },
    {
      name: 'r2',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'infini_environment',
      title: 'Infini Environment',
      type: 'select',
      value: 'sandbox',
      options: [
        { title: 'Sandbox', value: 'sandbox' },
    ...
    {
      name: 'infini_key_id',
      title: 'Infini Key ID (Public Key)',
      type: 'text',
      placeholder: 'xxx',
      tip: 'Infini merchant public key for API authentication',
      group: 'infini',
      tab: 'payment',
    },
    {
      name: 'infini_secret_key',
      title: 'Infini Secret Key (Private Key)',
      type: 'password',
      placeholder: 'xxx',
      tip: 'Infini merchant private key for HMAC-SHA256 signing. Only shown once, keep it safe.',
      group: 'infini',
      tab: 'payment',
    },
    {
      name: 'infini_webhook_secret',
      title: 'Infini Webhook Secret',
      type: 'password',
      placeholder: 'xxx',
      tip: 'Infini Webhook Secret is used to verify the webhook notification from Infini',
      group: 'infini',
      tab: 'payment',
    },
    {
    ...
    {
      name: 'sendflare_api_key',
      title: 'Sendflare API Key',
      type: 'password',
      placeholder: 'sf_xxx',
      group: 'sendflare',
      tab: 'email',
      tip: 'Sendflare API Key from <a href="https://sendflare.com" class="text-primary" target="_blank">sendflare.com</a>',
    },
    {
