...
import { ScrollPicker } from '@/components/astrokline/ui/scroll-picker';
...
const LocationAutocomplete = dynamic(
  () =>
    import('@/components/astrokline/ui/location-autocomplete').then((module) => ({
          ...
          <div className="mt-5 flex flex-col gap-3 border border-white/10 bg-white/[0.02] p-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-white/55">
                We can carry these birth details into the full AstroKline reading.
              </p>
            </div>
            <button
              type="button"
