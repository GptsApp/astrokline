...
export function MysticalBorder({ children, className, isActive = false }: MysticalBorderProps) {
  return (
      ...
      <div className="absolute inset-0 pointer-events-none z-20">
        ...
        >
          <defs>
            ...
            <filter id="mystical-glow" x="-20%" y="-20%" width="140%" height="140%">
          ...
          >
            ...
            {/* Inner Thin Box */}
            <rect x="4%" y="4%" width="92%" height="92%" rx="12" strokeWidth="0.5" strokeOpacity="0.7"/>
