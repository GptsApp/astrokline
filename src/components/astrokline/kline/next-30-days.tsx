  ...
  return (
    <div className="w-full">
      ...
      <div className="relative grid gap-6 md:grid-cols-2">
        {/* Glow behind */}
        <div className="pointer-events-none absolute top-1/2 left-1/2 h-[150%] w-full -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#D4AF37]/5 blur-[100px]" />

        {/* DOs Card */}
        <div className="group relative overflow-hidden rounded-2xl border border-emerald-500/20 bg-[#15131A] p-6 transition-colors hover:border-emerald-500/40">
        ...
        {/* DONTs Card */}
        <div className="group relative overflow-hidden rounded-2xl border border-rose-500/20 bg-[#15131A] p-6 transition-colors hover:border-rose-500/40">
          ...
          <div className="mb-4 flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold tracking-widest text-rose-400 uppercase">
              Danger Zone (Stop)
            </h3>
          </div>
          <ul className="space-y-4">
