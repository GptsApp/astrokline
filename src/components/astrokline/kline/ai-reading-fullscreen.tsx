      ...
      >
        ...
        <div className="pointer-events-none fixed inset-0 flex items-center justify-center overflow-hidden">
          <motion.div
            ...
            className="absolute top-[20%] left-[20%] h-[500px] w-[500px] rounded-full bg-indigo-500/10 blur-[120px]"
          />
          <motion.div
            animate={{
              scale: [1, 1.3, 1],
            ...
            className="absolute right-[10%] bottom-[10%] h-[600px] w-[600px] rounded-full bg-violet-600/10 blur-[150px]"
          />
        </div>
        {/* Top Bar */}
          ...
          <div className="flex items-center gap-2">
            {insight && (
              <button
                type="button"
                onClick={handleCopy}
                className="flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-xs text-white/60 transition-all hover:bg-white/10 hover:text-white/90"
              >
                {copied ? (
        ...
        {loading && (
          <div className="flex min-h-[60vh] flex-col items-center justify-center gap-6">
            <div className="relative">
              <div className="bg-primary/10 border-primary/30 flex h-16 w-16 items-center justify-center rounded-full border">
                <Brain className="text-primary h-8 w-8 animate-pulse" />
              </div>
              <div className="border-primary/20 absolute -inset-4 animate-ping rounded-full border" />
            </div>
        ...
        {error && (
          <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
            ...
            <button
              ...
              className="bg-primary/20 text-primary hover:bg-primary/30 rounded-lg px-4 py-2 text-sm font-medium transition-colors"
            >
              Retry
            </button>
          </div>
        ...
        {insight && (
          ...
          >
            ...
            >
              ...
              {insight.nickname && (
                <h1 className="font-serif text-3xl font-bold text-white/90 md:text-5xl">
                  {insight.nickname}
                </h1>
              )}
              {insight.coreQuote && (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="bg-primary/10 border-primary/20 flex h-10 w-10 items-center justify-center rounded-xl border shadow-[0_0_20px_rgba(139,92,246,0.1)]">
                  <Brain className="text-primary h-5 w-5" />
                </div>
                <div>
                  <h2 className="font-serif text-xl font-bold text-white/90">
            ...
            {insight.career && (
              <>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-blue-500/20 bg-blue-500/10 shadow-[0_0_20px_rgba(59,130,246,0.1)]">
            ...
            {insight.wealth && (
              <>
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-emerald-500/20 bg-emerald-500/10 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
            ...
            {!isPremium ? (
              <div className="relative mt-8 border-t border-white/5 pt-8">
                ...
                <div className="absolute inset-x-0 top-32 z-20 flex flex-col items-center justify-center px-4">
                  <div className="border-primary/20 w-full max-w-xl rounded-2xl border bg-black/60 p-8 text-center shadow-[0_0_40px_rgba(212,175,55,0.1)] backdrop-blur-md">
                    <div className="bg-primary/20 mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full">
                      <Lock className="text-primary h-6 w-6" />
                    </div>
                    <h3 className="font-serif text-2xl font-bold text-white/90">
                ...
                <div className="touch-none space-y-10 opacity-10 blur-md select-none">
                  ...
                  <div className="h-32 rounded-xl bg-white/5 pl-[52px]" />
              ...
              <>
                ...
                {insight.relationships && (
                  <>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-rose-500/20 bg-rose-500/10 shadow-[0_0_20px_rgba(244,63,94,0.1)]">
                          <Heart className="h-5 w-5 text-rose-400" />
                        </div>
                        <div>
                          <h2 className="font-serif text-xl font-bold text-white/90">
                ...
                {insight.health && (
                  <>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-teal-500/20 bg-teal-500/10 shadow-[0_0_20px_rgba(20,184,166,0.1)]">
                          <Activity className="h-5 w-5 text-teal-400" />
                        </div>
                        <div>
                          <h2 className="font-serif text-xl font-bold text-white/90">
                ...
                {insight.warnings && (
                  <>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-amber-500/20 bg-amber-500/10 shadow-[0_0_20px_rgba(245,158,11,0.1)]">
            ...
            <div className="space-y-3 border-t border-white/5 pt-8 pb-12 text-center">
              ...
              <button
                type="button"
                onClick={handleCopy}
                className="mt-4 inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-xs text-white/50 transition-all hover:bg-white/10 hover:text-white/80"
              >
                {copied ? (
