    ...
    <>
      ...
      <div className="flex items-center gap-3 mt-2 mb-6">
        <p className="text-[10px] tracking-[0.2em] text-primary uppercase font-mono">
          {step === 0 ? 'Your Birthday' : 'Time & Place'} {"//"} Step {step + 1} of 2
        </p>
      ...
      <div className="mt-6 flex gap-3">
        ...
        >
          {step === 0 ? "Next: Time & Place →" : "See My Timeline ✨"}
      ...
      <div className="text-center mt-5 flex justify-center items-center gap-2 opacity-50">
         <span className="w-4 h-4 border border-white/20 flex items-center justify-center text-[8px] font-mono">🔒</span>
         <p className="text-[9px] font-mono text-muted-foreground uppercase tracking-widest">
           {step === 0 ? 'Never stored. Never shared.' : 'Your data is encrypted and never stored.'}
         </p>
      </div>
    </>
  );
