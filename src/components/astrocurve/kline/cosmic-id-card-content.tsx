...
export function CosmicIdCardContent({ profile, klineData, cardRef, shareUrl = 'https://www.astrocurve.net/kline' }: Props) {
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between px-5 pt-5">
        <div className="flex items-center gap-2">
          ...
          <img src="/logo.png" alt="AstroCurve" className="h-5 w-5" />
          <span className="font-mono text-[8px] font-bold tracking-[0.3em] text-[#D4AF37] uppercase">Cosmic ID</span>
        </div>
        <span className="font-mono text-[7px] tracking-wider text-white/15 uppercase">www.astrocurve.net</span>
      </div>
