  ...
  return (
    <div className="relative mt-24 flex w-full flex-col items-center border-t border-white/5 pt-16 pb-32 text-center">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col gap-3">
                ...
                if (klineId) {
                  ...
                  try {
                    ...
                    if (res.ok) {
                      ...
                      a.href = url;
                      a.download = `${profile.name || 'AstroCurve'}-Life-Report.pdf`;
                      a.click();
            ...
            >
              ...
              <span>Invite Friends to Try AstroCurve</span>
            </button>
            {showSharePrompt && (
      ...
      <p className="mt-16 max-w-2xl text-center font-mono text-[10px] leading-relaxed tracking-wide text-white/20">
        Disclaimer: AstroCurve provides astrological insights for personal
