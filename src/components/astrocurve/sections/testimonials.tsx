...
const REVIEWS = [
  {
    quote: "I used to read daily horoscopes. AstroCurve gave me a 5-year strategic map. Avoided a massive bad partnership during my 'Weak Window'.",
  ...
  {
    quote: "We use AstroCurve charts in our leadership coaching. Clients respond much better when they can see the timing visually.",
      ...
      <div className="relative z-10">
        <div className="text-center mb-12 px-6">
          <div className="inline-flex items-center gap-1.5 mb-4">
            ...
            <span className="ml-2 text-sm font-mono text-white/60">4.7 / 5</span>
            <span className="text-xs text-white/60 font-mono ml-1">(200+ reviews)</span>
          </div>
        ...
        <div className="mt-12 text-center">
          <a
            href="#pricing"
            className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 hover:bg-primary/10 text-primary px-6 py-3 text-sm font-medium uppercase tracking-widest transition-all"
          >
            See Plans & Pricing
          </a>
        </div>
