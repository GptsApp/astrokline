    ...
    <section aria-labelledby="cta-heading" data-testid="cta-section" className="py-32 relative overflow-hidden bg-[#0A0A0A]">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <Button
            size="lg"
            className="h-14 px-8 text-sm bg-primary text-primary-foreground hover:bg-primary/90 font-bold transition-all hover:scale-105 uppercase tracking-widest shadow-[0_0_30px_rgba(212,175,55,0.3)] hover:shadow-[0_0_50px_rgba(212,175,55,0.4)] md:h-14 md:text-base"
