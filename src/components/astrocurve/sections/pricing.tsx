...
const plans: Plan[] = [
  {
    ...
    yearlyPrice: '$0',
    period: '/mo',
    description: PLAN_ENTITLEMENTS.FREE.shortDescription,
    features: PLAN_ENTITLEMENTS.FREE.features.map((text) => ({ text })),
    cta: 'Start Free',
    tier: 'FREE',
  },
  {
    ...
    period: '/mo',
    description: PLAN_ENTITLEMENTS.LITE.shortDescription,
    features: PLAN_ENTITLEMENTS.LITE.features.map((text) => ({ text })),
    cta: 'Choose Lite',
    tier: 'LITE',
  ...
  },
  {
    ...
    period: '/mo',
    description: PLAN_ENTITLEMENTS.PRO.shortDescription,
    features: PLAN_ENTITLEMENTS.PRO.features.map((text) => ({ text })),
    cta: 'Choose Pro',
    tier: 'PRO',
