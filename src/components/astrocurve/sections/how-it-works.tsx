      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          <Heading level={2} variant="section" className="mb-4">
            {section?.title || 'Your Chart in 10 Seconds'}
          </Heading>
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="group-hover:border-primary/30 relative mb-6 flex h-24 w-24 items-center justify-center overflow-hidden  border border-white/5 bg-[#111] shadow-[0_0_30px_rgba(212,175,55,0.05)] transition-colors duration-500">
                ...
                <div className="text-primary/80 absolute top-2 right-2 font-mono text-[10px]">
                  {`0${idx + 1}`}
                </div>
              </div>
        ...
        <div className="mt-20 flex justify-center">
          <button
            type="button"
            onClick={() => open(() => { router.push('/kline'); })}
            className="group rounded-full border-primary/20 bg-primary/5 hover:bg-primary/10 text-primary relative flex items-center gap-3 border px-8 py-3 font-medium shadow-[0_0_15px_rgba(212,175,55,0.05)] transition-all hover:shadow-[0_0_25px_rgba(212,175,55,0.15)]"
          >
            <span>Map My Timeline — Free</span>
