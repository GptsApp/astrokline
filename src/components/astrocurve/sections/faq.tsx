...
export function FAQ() {
  const faqs = [
    {
      question: "How is AstroCurve different from a daily horoscope?",
      answer: "Daily horoscopes use only your Sun sign — 1 of 12 generic patterns. AstroCurve uses your exact birth time, date, and location to calculate the precise planetary geometry unique to you. The result is a personalized timing curve no generic horoscope could ever produce."
    },
    {
    ...
    },
    {
      ...
      answer: "For the most accurate results, yes. Your birth time determines your Rising Sign, house layout, and timing periods. If you only know the date of birth, AstroCurve can still show major astrology trends and general compatibility, just with less precision for specific life areas."
    },
    {
