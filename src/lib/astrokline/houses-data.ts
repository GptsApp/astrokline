...
export const ASTROLOGY_HOUSES: House[] = [
  {
    ...
    klineInsight: "When major planetary transits hit your 1st House, your Life Curve often spikes with intense personal growth. This is a period of reinvention, where changes to your identity or physical self heavily influence your overall momentum score.",
  ...
  },
  {
    ...
    klineInsight: "Activity in the 2nd House directly impacts your financial timing curve. Beneficial transits here indicate high momentum for wealth accumulation and salary bumps, while challenging transits warn of resource friction where you must protect capital.",
  ...
  },
  {
    ...
    klineInsight: "When your 3rd House is active, your Life Curve reflects an influx of ideas, negotiations, and learning. It's a high-friction period for communication, meaning important contract signings or learning curves are critical to your timeline.",
  ...
  },
  {
    ...
    klineInsight: "Transits through the 4th House often represent a recharging phase on your Life Curve. Momentum shifts from external career goals to internal, domestic matters. It's a key timing indicator for buying real estate or starting a family.",
  ...
  },
  {
    ...
    klineInsight: "Your synastry and romance timing models heavily monitor the 5th House. Major transits here predict high-momentum phases for new relationships, creative breakthroughs, and speculative investments.",
  ...
  },
  {
    ...
    klineInsight: "The 6th House is the engine of your Life Curve. When transits hit, it signals a period of high friction where hard work, health optimization, and skill-building lay the groundwork for future peaks.",
  ...
  },
  {
    ...
    klineInsight: "This is the ultimate house for astrology synastry. A peak timing score during 7th House transits flags the perfect window for engagements, major business contracts, or resolving deep relationship friction.",
  ...
  },
  {
    ...
    klineInsight: "8th House transits often create dramatic V-shaped recoveries on the Life Curve. It signifies deep transformation: periods where old structures break down to release massive hidden potential or shared wealth.",
  ...
  },
  {
    ...
    klineInsight: "When your Life Curve spikes because of 9th House transits, expect expansion. This indicates prime timing for global travel, advanced education, or publishing. It's a macro-trend indicator for broadening horizons.",
  ...
  },
  {
    ...
    klineInsight: "10th House transits are the most critical events for your career timing curve. Powerful aspects here correlate with the highest momentum peaks in your life: promotions, public recognition, and status shifts.",
  ...
  },
  {
    ...
    klineInsight: "An active 11th House signifies a peak in social capital. Your timing model sees this as a high-leverage period where networking, community building, and internet-based projects yield outsized returns.",
  ...
  },
  {
    ...
    klineInsight: "The 12th House often represents the lowest-friction points on the Life Curve. Major transits here dictate highly introspective, restorative periods. The timing model advises against launching projects here; instead, it's a protective phase for inner work.",
