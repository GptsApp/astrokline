  ...
  2023: [
    {
      ...
      theme: 'Career',
      description:
        'Uranus strongly squares your Midheaven, creating sudden friction with authority figures. The structures you relied on are shaken, forcing you to reconsider your true professional calling.',
      impactScore: 9,
      planet: 'Uranus',
      aspect: 'Square',
      advice:
        'Do not resist the structural changes occurring in your workplace. The friction is a signal to pivot towards independence rather than climbing a broken ladder.',
      phase: 'Applying',
    },
  ],
  2024: [
    {
      ...
      theme: 'Growth',
      description:
        'As Pluto forms a supportive trine to your Sun, you step into a profound sense of personal power. The trials of the previous year have hardened your resolve, allowing you to manipulate circumstances to your advantage.',
      impactScore: 8,
      planet: 'Pluto',
      aspect: 'Trine',
      advice:
        'Now is the time for strategic moves. People in power are receptive to your ideas. Consolidate your influence quietly.',
      phase: 'Exact',
    },
  ],
  2025: [
    {
      ...
      theme: 'Wealth',
      description:
        'Jupiter, the planet of expansion, makes a perfect trine to your career sector. Years of unseen hard work finally culminate in public recognition and material growth.',
      impactScore: 10,
      planet: 'Jupiter',
      aspect: 'Trine',
      advice:
        'Do not play small. Ask for the promotion, raise your rates, and launch publicly. The cosmic wind is entirely at your back.',
      phase: 'Separating',
    },
  ],
  2026: [
    {
      ...
      theme: 'Wealth',
      description:
        "After the massive expansion of the previous year, Saturn helps you structure your gains. It's time to build a long-lasting financial fortress rather than chasing the next big hit.",
      impactScore: 8,
      planet: 'Saturn',
      aspect: 'Sextile',
      advice:
        'Invest in solid assets. Lock in your profits from last year and establish rigid boundaries around your time and capital.',
      phase: 'Applying',
    },
  ],
};
